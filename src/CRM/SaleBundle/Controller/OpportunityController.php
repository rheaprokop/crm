    ...
    public function indexAction() {
        ...
        $query = $em->createQuery(
                'SELECT a
                        ...
                        AND b.category = 
                            (Select c.id from CRMContactBundle:Category c where c.name = \'Opportunity\'  
                            and c.creationUser = \'' . $this->getUser()->getUsername() . '\') 
        ...
        return $this->render('CRMSaleBundle:Opportunity:index.html.twig', array(
                    'leads' => $leads,
